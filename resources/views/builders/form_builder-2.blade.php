                                                ...
                                                <nav class="navbar navbar-expand-md p-0">
                                                    <form class="form-inline">
                                                        ...
                                                        <button class="btn btn-primary copy-btn" id="copy-to-clipboard"
                                                            type="submit" data-clipboard-text="testing">Copy HTML</button>
                                                    </form>
                                                </nav>
                                            </div>
                                        </div>
                                                ...
                                                <form class="theme-form">
                                                    ...
                                                    <div class="mb-3 draggable">
                                                        ...
                                                        <div class="input-group"><span class="input-group-text">
                                                            ...
                                                            <input class="form-control btn-square" id="prependedcheckbox"
                                                                name="prependedcheckbox" type="text"
                                                    ...
                                                    <div class="mb-3 draggable">
                                                        ...
                                                        <div class="input-group right-radius">
                                                            ...
                                                            <div class="input-group-text p-0 overflow-hidden">
                                                                <button class="btn btn-primary dropdown-toggle btn-square"
                                                                    type="button" data-bs-toggle="dropdown">Action<span
                                                                        class="caret"></span></button>
                                                                <ul class="dropdown-menu pull-right">
                                                                    <li><a class="dropdown-item"
                                                                            href="javascript:void(0)">Option one</a></li>
                                                                    <li><a class="dropdown-item"
                                                                            href="javascript:void(0)">Option two</a></li>
                                                                    <li><a class="dropdown-item"
                                                                            href="javascript:void(0)">Option three</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <p class="help-block">Example block-level help text here.</p>
                                            ...
                                            <div class="tab-pane fade" id="pills-radcheck" role="tabpanel"
                                                ...
                                                <form class="theme-form">
                                                    <div class="mb-3 draggable">
                                                        ...
                                                        <p class="help-block m-t-help-block">Example block-level help text
                                                            here.</p>
                                                    </div>
                                                    <hr>
                                                    <div class="mb-3 draggable">
                                            ...
                                            <div class="tab-pane fade" id="pills-select" role="tabpanel"
                                                ...
                                                <form class="theme-form">
                                                    ...
                                                    <div class="mb-3 draggable">
                                                        ...
                                                        <select class="form-control btn-square" id="formcontrol-select2"
                                                            multiple="">
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                    ...
                                    <div class="col-lg-6 col-xl-6 lg-mt">
                                        ...
                                        <div class="drag-bx card-body">
                                            <div class="text-muted empty-form text-center">
                                                <h3>Drag & Drop elements to build form.</h3>
                                            </div>
