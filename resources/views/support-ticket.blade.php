            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Ticket List</h3><span>List of ticket opend by customers</span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                <div class="text-md-end">
                                                    <ul>
                                                        <li>Profit<span class="product-stts txt-primary ms-2">8989<i
                                                                    class="icon-angle-up f-12"></i></span></li>
                                                        <li>Loss<span class="product-stts txt-danger ms-2">2560<i
                                                                    class="icon-angle-down f-12"></i></span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <table class="display" id="basic-6">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>3 year</td>
                                        <td> <i class="fa fa-eye font-primary pe-2"></i><i class="icofont icofont-close-circled font-danger ps-2"></i></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="d-flex"><img class="rounded-circle img-30 me-3"
