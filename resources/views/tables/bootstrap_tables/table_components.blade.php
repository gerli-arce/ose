                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="dropdown-menu">
                                <h6 class="dropdown-header">Dropdown header</h6><a class="dropdown-item" href="javascript:void(0)">Action</a><a class="dropdown-item" href="javascript:void(0)">Another action</a><a class="dropdown-item" href="javascript:void(0)">Something else here</a>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="w-50">
                              ...
                              <label class="mb-0" for="checkbox1">Default</label>
                            </td>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="w-50">
                              ...
                              <label class="mb-0" for="radio">Default radio</label>
                            </td>
                      ...
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><span>Use  <code>a href="javascript:void(0)"</code> for link trigger. This is a link trigger</span></td>
                          </tr>
                          <tr>
