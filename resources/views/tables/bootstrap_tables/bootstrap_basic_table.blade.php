    ...
    <div class="container-fluid basic_table">
        <div class="row">
                            ...
                            <tbody>
                                <tr class="border-bottom-secondary">
                                    ...
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/1.png') }}" alt="">Ram
                                        Jacob</td>
                                    <td>Wolfe</td>
                                ...
                                <tr class="border-bottom-success">
                                    <th scope="row">2</th>
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/2.png') }}" alt="">John
                                        Deo</td>
                                    <td>Gummer</td>
                                ...
                                <tr class="border-bottom-info">
                                    <th scope="row">3</th>
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/3.png') }}"
                                            alt="">Elana John</td>
                                    <td>Cazale </td>
                                ...
                                <tr class="border-bottom-warning">
                                    <th scope="row">4</th>
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/4.png') }}"
                                            alt="">Meryl Streep</td>
                                    <td>Roberts</td>
                                ...
                                <tr class="border-bottom-danger">
                                    <th scope="row">5</th>
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/1.png') }}" alt="">Emma
                                        Stone</td>
                                    <td>Stone</td>
                                ...
                                <tr class="border-bottom-light">
                                    <th scope="row">6</th>
                                    <td> <img class="img-30 me-2"
                                            src="{{ asset('assets/images/dashboard/beyo-line/2.png') }}"
                                            alt="">Eliana Jons</td>
                                    <td>Jons</td>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Hoverable Rows With Horizontal Border</h3><span>Hoverable row use a class
                            <code>table-hover</code> and for Horizontal border use a class
                            <code>.table-border-horizontal</code> , Solid border Use a class<code>.border-solid
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Inverse Table with Primary background</h3><span>Use a class <code>.bg-info, .bg-success,
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Caption</h3><span>A <code>&lt;caption&gt;</code> functions like a heading for a table. It helps
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h3>Table head options</h3><span>Similar to tables , use the modifier
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h3>Striped Row with Inverse Table</h3><span>Use <code>.table-striped</code> to add zebra-striping
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Breckpoint Specific</h3><span>Use <code>.table-responsive"❴-sm|-md|-lg|-xl|-xxl❵"</code>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Responsive Tables With Light Background</h3><span>A <code>.table-responsive ,
                                .table-light</code> inside table element.</span>
                    </div>
                    <div class="card-block row">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Custom Table Color With Hover And Stripped</h3><span>Use class <code>table-hover, table-striped
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Dashed Border </h3><span>Dashed border use class <code>.table-dashed</code> , for Dotted border
