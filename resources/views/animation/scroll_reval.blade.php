    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials" itemscope="">
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia" itemscope=""><a
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/08.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/09.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/010.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/011.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/012.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/013.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/014.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/015.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/016.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/01.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/lightgallry/01.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/02.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/lightgallry/02.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/03.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/lightgallry/03.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/04.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/lightgallry/04.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                            ...
                            <figure class="reveal col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-lightgallry/05.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/lightgallry/05.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>How to Use Scroll Reveal(Customize options according to requirements)</h3><span>Add
                            <code>.reveal</code> class to any tag for Archive animation like this</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-b-15"><span class="comment">// Can be any valid CSS distance, e.g. '5rem', '10%',
                                '20vw', etc.</span>
                        ...
                        <div class="p-b-15"><span class="comment">// Starting angles in degrees, will transition from
                                these values to 0 in all axes.</span>
                            <div class="line">rotate: { x: <span class="text-danger">0</span>, y: <span
                                    class="text-danger">0</span>, z: <span class="text-danger">0</span> },</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Starting opacity value, before transitioning to the
                                computed opacity.</span>
                            <div class="line">opacity: <span class="text-danger">0</span>,</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Starting scale value, will transition from this value
                                to 1</span>
                            <div class="line">scale: <span class="text-danger"> 0.9</span>,</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Accepts any valid CSS easing, e.g. 'ease',
                                'ease-in-out', 'linear', etc.</span>
                            <div class="line">easing: 'cubic-bezier(0.6, 0.2, 0.1, 1)',</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// is the default reveal container. You can pass
                                either:<br> // DOM Node, e.g. document.querySelector('.fooContainer')<br> // Selector, e.g.
                                '.fooContainer'</span>
                            <div class="line">easing: 'cubic-bezier(0.6, 0.2, 0.1, 1)',</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// true/false to control reveal animations on
                                mobile.</span>
                            <div class="line">mobile: true,</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// true: reveals occur every time elements become
                                visible<br> // false: reveals occur once as elements become visible</span>
                            <div class="line">reset: false,</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// 'always' — delay for all reveal animations<br> //
                                'once' — delay only the first time reveals occur<br> // 'onload' - delay only for animations
                                triggered by first load</span>
                            <div class="line">useDelay: 'always',</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Change when an element is considered in the viewport.
                                The default value<br> // of 0.20 means 20% of an element must be visible for its reveal to
                                occur.</span>
                            <div class="line">viewFactor: 0.2,</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Pixel values that alter the container boundaries.<br>
                                // e.g. Set `{ top: 48 }`, if you have a 48px tall fixed toolbar.<br> // --<br> // Visual
                                Aid: https://scrollrevealjs.org/assets/viewoffset.png</span>
                            <div class="line">viewOffset: { top: 0, right: 0, bottom: 0, left: 0 },</div>
                        </div>
                        <div class="p-b-15"><span class="comment">// Callbacks that fire for each triggered element
                                reveal, and reset.</span>
                        ...
                        <div><span class="comment">// Callbacks that fire for each completed element reveal, and
                                reset.</span>
