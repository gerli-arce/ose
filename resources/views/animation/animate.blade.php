                                ...
                                <div id="animation-box">
                                    <div class="card">
                                        <div class="animate-widget">
                                            <div><img class="img-fluid" src="{{ asset('assets/images/banner/3.jpg') }}" alt="">
                                            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>How to use it?</h3><span>All you have to do is to add animation name class attribute to html
                            element, like :<code>Fade</code></span>
                    </div>
