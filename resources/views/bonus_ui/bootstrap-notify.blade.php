            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Bootstrap Notify</h3><span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-url" type="checkbox"><span
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-dismiss" type="checkbox"><span
                                                        class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-pause" type="checkbox"><span
                                                        class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-top" type="checkbox"><span
                                                        class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-title" type="checkbox"><span
                                                        class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="flex-grow-1 text-start icon-state">
                                                <label class="switch">
                                                    <input id="bootstrap-notify-progress" type="checkbox"><span
                                                        class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-6 theme-form sm-form">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-spacing"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-offset-x"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-offset-y"
                                                type="number" value="30">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-delay" type="number"
                                                value="1000">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-timer" type="number"
                                                value="2000">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input class="form-control digits" id="bootstrap-notify-z-index"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-select form-control height-35"
                                                id="bootstrap-notify-state">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3>Example Of How To Use Bootstrap Notify</h3><span>Click Display Notify button to show
                                    different notify demo's & display script of different Notify demo below</span>
