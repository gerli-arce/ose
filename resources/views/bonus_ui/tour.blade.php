            ...
            <div class="row">
                        ...
                        <div class="userpro-box">
                            <div class="img-wrraper">
                                <div class="avatar"><img class="img-fluid" alt="" src="{{ asset('assets/images/user/7.jpg') }}"
                                        data-intro="This is Profile image"></div><a class="icon-wrapper"
                                    href="{{ route('edit-profile') }}"><i class="icofont icofont-pencil-alt-5"
                                        data-intro="Change Profile image here"></i></a>
                            </div>
                                    ...
                                    <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                        ...
                                        <div class="card-body post-about">
                                            ...
                                            <div class="social-network theme-form"><span class="f-w-600">Social
                                                    Networks</span><a class="btn social-btn btn-fb mb-2 text-center"
                ...
                <div class="col-xl-9 col-lg-12 col-md-7 xl-65 box-col-65">
                    <div class="row">
                                ...
                                <div class="profile-post">
                                    ...
                                    <div class="post-body">
                                        <div class="img-container">
                                            <div class="my-gallery" itemscope="">
                                                <figure itemprop="associatedMedia" itemscope=""><a
                                                        href="{{ asset('assets/images/user-profile/post1.jpg') }}"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                        ...
                                        <div class="post-react">
                                            <ul>
                                                <li><img class="rounded-circle" src="{{ asset('assets/images/user/3.jpg') }}"
                                                        alt=""></li>
                                                <li><img class="rounded-circle" src="{{ asset('assets/images/user/5.jpg') }}"
                                                        alt=""></li>
                                                <li><img class="rounded-circle" src="{{ asset('assets/images/user/1.jpg') }}"
                                                        alt=""></li>
                                            </ul>
                                        ...
                                        <ul class="post-comment">
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="heart"></i>&nbsp;&nbsp;Like<span
                                            ...
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="share"></i>&nbsp;&nbsp;share<span
                        ...
                        <!-- profile post end-->
                        <!-- profile post start-->
                        <div class="col-sm-12" data-intro="This is the your Last Post">
                            <div class="card">
                                <div class="profile-post">
                                    <div class="post-header">
                                        <div class="d-flex"><img class="img-thumbnail rounded-circle me-3"
                                    ...
                                    <div class="post-body">
                                        <div class="img-container">
                                            <div class="row mt-4 pictures my-gallery" itemscope="">
                                                <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                                        href="{{ asset('assets/images/user-profile/post2.jpg') }}"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                                ...
                                                <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                                        href="{{ asset('assets/images/user-profile/post3.jpg') }}"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                        ...
                                        <ul class="post-comment">
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="heart"></i>&nbsp;&nbsp;Like<span
                                                            class="counter">520</span></a></label>
                                            </li>
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="message-square"></i>&nbsp;&nbsp;Comment<span
                                                            class="counter">85</span></a></label>
                                            </li>
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="share"></i>&nbsp;&nbsp;share<span
                                                            class="counter">30</span></a></label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="profile-post">
                                    ...
                                    <div class="post-body">
                                        <div class="img-container">
                                            <div class="my-gallery" itemscope="">
                                                <figure itemprop="associatedMedia" itemscope=""><a
                                                        href="{{ asset('assets/images/user-profile/post4.jpg') }}"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                        ...
                                        <ul class="post-comment">
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="heart"></i>&nbsp;&nbsp;Like<span
                                                            class="counter">407</span></a></label>
                                            </li>
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="message-square"></i>&nbsp;&nbsp;Comment<span
                                                            class="counter">302</span></a></label>
                                            </li>
                                            <li>
                                                <label><a href="javascript:void(0)"><i
                                                            data-feather="share"></i>&nbsp;&nbsp;share<span
                                                            class="counter">180</span></a></label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
