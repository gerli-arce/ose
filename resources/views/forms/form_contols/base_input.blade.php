    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <form class="form theme-form">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect3">Example multiple
                                            select</label>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Basic HTML input control</h3>
                    </div>
                    <form class="form theme-form">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control m-input digits" type="number" value="91999999999"
                    ...
                    <form class="form theme-form">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect8">Example multiple
                                            select</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div>
                                        <label class="form-label" for="exampleFormControlTextarea9">Example
                                            textarea</label>
                    ...
                    <form class="form theme-form">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control btn-square" id="exampleFormControlInput10"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control btn-square" id="exampleInputPassword11"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect13">Example multiple
                                            select</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div>
                                        <label class="form-label" for="exampleFormControlTextarea14">Example
                                            textarea</label>
                    ...
                    <form class="form theme-form">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control input-air-primary" id="exampleInputPassword22" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect18">Example multiple
                                            select</label>
                                        <select class="form-select input-air-primary digits"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div>
                                        <label class="form-label" for="exampleFormControlTextarea19">Example
                                            textarea</label>
                    ...
                    <form class="form theme-form">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput20" type="email"
                                            placeholder="name@example.com">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleInputPassword21" type="password"
                                            placeholder="Password">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect24">Example multiple
                                            select</label>
                                        <select class="form-select digits" id="exampleFormControlSelect24"
                                            multiple="">
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div>
                                        <label class="form-label" for="exampleFormControlTextarea25">Example
                                            textarea</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleInputPassword27" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-sm" id="colFormLabelSm28" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-control-lg digits"
                                            id="exampleFormControlSelect29">
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div>
                                        ...
                                        <select class="form-select form-control-sm digits"
