          ...
          <div class="col-sm-12">
            <div class="card" id="default">
              <div class="card-header pb-0">
                <h3>Default buttons</h3><span>Bootstrap state buttons</span>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card">
              <div class="card-header pb-0">
                <h3>Flat button</h3><span>Add <code>.btn-square</code> class for flat button</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt; </code></pre>
            ...
            <div class="card">
              <div class="card-header pb-0">
                <h3>Raised with Edge buttons</h3><span>Add <code>.btn-pill</code> and <code>.btn-air-*</code> class button</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card">
              ...
              <div class="card-body btn-group-showcase">
                <div class="row">
                  <div class="col-xl-4 box-col-6 col-sm-12">
                  ...
                  <div class="col-xl-4 box-col-6 col-sm-12 button-group-mb-sm">
                    <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <div class="card" id="large-btn">
              <div class="card-header pb-0">
                <h3>Sizing buttons</h3><span>Add <code>.btn-lg</code><code>.btn-sm</code><code>.btn-xs</code> class for Different Sizing buttons</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card" id="active-btn">
              <div class="card-header pb-0">
                <h3>Active Buttons</h3><span>Add <code>.active</code> class for active state</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card" id="disabled-btn">
              <div class="card-header pb-0">
                <h3>Disabled buttons</h3><span>Add <code>.disabled</code> class or <code>disabled="disabled"</code> attribute for disabled button</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card" id="outline-button">
              <div class="card-header pb-0">
                <h3>outline buttons</h3><span>Add <code>.btn-outline-*</code> class for border button</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card" id="outline-bold-button">
              <div class="card-header pb-0">
                <h3>bold Border outline buttons</h3><span>Add <code>.btn-outline-*-2x</code> class for bold outline</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card" id="gradiant">
              <div class="card-header pb-0">
                <h3>Gradien buttons</h3><span>Add <code>.btn-*-gradien</code> class for gradien button</span>
                <div class="card-header-right">
                  <ul class="list-unstyled card-option">
                    <li>
                      <div><i class="icon-settings"></i></div>
