    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Basic & Edges Button Group</h3><span>Use<code>.btn-group-pill </code> For Edge Button</span>
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Flat Button Group</h3><span>Use<code>.btn-group-square </code> For Flat Button</span>
              </div>
              <div class="card-body btn-group-showcase">
                <div class="row">
                  <div class="col-xxl-4 col-md-6 col-sm-12">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Sizing Button Group</h3><span>Useing Size For Different Size <code>.btn-lg , .btn-sm </code></span>
              </div>
              <div class="card-body btn-group-showcase">
                <div class="row">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Outline Custom button group</h3>
              </div>
              <div class="card-body btn-group-showcase">
                <div class="row">
                  <div class="col-xxl-4 col-md-6 col-sm-12">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Radio button group</h3><span>Add <code>.active</code> for active state and<code>.disabled</code> class or <code>disabled="disabled"</code> attribute</span>
              </div>
              <div class="card-body btn-group-showcase">
                <div class="row">
                  <div class="col-xxl-4 col-md-6 col-sm-12">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0">
                <h3>Check Box button group</h3><span>Add <code>.active</code> for active state and <code>.disabled</code> class or <code>disabled="disabled"</code> attribute</span>
              </div>
              <div class="card-body btn-group-showcase">
                <div class="row">
                  <div class="col-xl-6 col-sm-12">
          ...
          <div class="col-lg-6">
            <div class="card height-equal">
              <div class="card-header pb-0">
                <h3>Nesting</h3><span>Make nesting buttons</span>
              </div>
          ...
          <div class="col-lg-6">
            <div class="card height-equal">
              <div class="card-header pb-0">
                <h3>Vertical</h3><span>Make vertical buttons</span>
              </div>
              <div class="card-body btn-group-wrapper">
                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1"><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a></div>
                  </div>
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2"><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a></div>
                  </div>
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop3"><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a><a class="dropdown-item" href="javascript:void(0)">Dropdown link</a></div>
                  </div>
                </div>
              </div>
            </div>
