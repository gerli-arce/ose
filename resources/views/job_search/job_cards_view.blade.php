        ...
        <div class="row">
            <div class="col-xl-3 box-col-30">
                <div class="md-sidebar job-sidebar"><a class="btn btn-primary md-sidebar-toggle"
                        href="javascript:void(0)">job filter</a>
                                ...
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details')}}">UI/UX IT Frontend
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details')}}">React/React Native Developer
                                                </a><span class="badge badge-primary pull-right">New</span></h3>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">Senior UX designer</a><span
                                                    class="pull-right">2 days ago</span></h3>
                                            <p>Minneapolis, MN</p>
                                            <ul class="rating">
                                                <li><i class="fa fa-star font-warning"></i></li>
                                                <li><i class="fa fa-star font-warning"></i></li>
                                    ...
                                    <p>Contented get distrusts certainty nay are frankness concealed ham. On unaffected resolution on considered of. No thought me husband forming effects. End sitting shewing who saw besides son musical adapted. Contrasted interested eat alteration pianoforte sympathize was.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">Front end web
                                                    developer</a><span class="pull-right">3 days ago</span></h3>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">Graphic designer</a><span
                                                    class="pull-right">3 days ago</span></h3>
                                    ...
                                    <p>The designer will apply Lean UX and Design Thinking practices in a highly collaborative, fast-paced, distributed environment You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding the evolution of team process standards.
                                    </p>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">Designer, CRM</a><span
                                                    class="pull-right">3 days ago</span></h3>
                                    ...
                                    <p>You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding the evolution of team process standards. The designer will apply Lean UX and Design Thinking practices in a highly collaborative, fast-paced, distributed environment.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">React/React Native Developer
                                                </a><span class="pull-right">5 days ago</span></h3>
                                            <p>San <span>Diego, CA</span></p>
                                            <ul class="rating">
                                                <li><i class="fa fa-star font-warning"></i></li>
                                                <li><i class="fa fa-star font-warning"></i></li>
                                    ...
                                    <p>We are looking for an experienced and zeta designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-600"><a href="{{ route('job-details') }}">Senior UX designer</a><span
                                                    class="pull-right">5 days ago</span></h3>
                                            <p>Minneapolis, MN</p>
                                            <ul class="rating">
                                                <li><i class="fa fa-star font-warning"></i></li>
                                                <li><i class="fa fa-star font-warning"></i></li>
                                    ...
                                    <p>3+ years of experience working in as a Frontend Engineer or comparable role. we are looking for an experienced and zeta designer and/or frontend engineer with expertise in accessibility to join our team.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="job-search">
                                <div class="card-body">
                                    ...
                                    <p>We are looking for an experienced and koho designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating coely with other...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="job-search">
                                <div class="card-body">
                                    ...
                                    <p>deally 2+ years experience with React. Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial , Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface</p>
                                </div>
                            </div>
                        </div>
                    </div>
