  ...
  <div class="container-fluid job-cardview">
    <div class="row">
      <div class="col-xl-3 xl-40 box-col-40">
        <div class="md-sidebar job-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">job filter</a>
      ...
      <div class="col-xl-9 xl-60 box-col-60">
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/1.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">UI/UX IT Frontend Developer</a><span class="badge badge-primary pull-right">New</span></h3>
        ...
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/2.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">React/React Native Developer</a><span class="badge badge-primary pull-right">New</span></h3>
                  <p>San Diego, CA </p>
                  <ul class="rating">
                    <li><i class="fa fa-star font-warning"></i></li>
                    <li><i class="fa fa-star font-warning"></i></li>
        ...
        <div class="card ribbon-vertical-left-wrapper">
          ...
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/3.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">Senior UX designer</a><span class="pull-right">2 days ago</span></h3>
                  <p>Minneapolis, MN</p>
                  <ul class="rating">
                    <li><i class="fa fa-star font-warning"></i></li>
                    <li><i class="fa fa-star font-warning"></i></li>
        ...
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/4.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">Front end web developer</a><span class="pull-right">3 days ago</span></h3>
        ...
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/5.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">Graphic designer</a><span class="pull-right">3 days ago</span></h3>
        ...
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/6.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">Designer, CRM</a><span class="pull-right">3 days ago</span></h3>
        ...
        <div class="card ribbon-vertical-left-wrapper">
          ...
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/2.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">UI designer E-commerce</a><span class="pull-right">5 days ago</span></h3>
        ...
        <div class="card">
          <div class="job-search">
            <div class="card-body">
              <div class="d-flex"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/3.jpg') }}" alt="">
                <div class="flex-grow-1">
                  <h3 class="f-w-600"><a href="{{ route('job-details') }}">Senior UX designer</a><span class="pull-right">5 days ago</span></h3>
                  <p>Minneapolis, MN </p>
                  <ul class="rating">
                    <li><i class="fa fa-star font-warning"></i></li>
                    <li><i class="fa fa-star font-warning"></i></li>
