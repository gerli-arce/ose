    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Basic Accordion</h3><span>Using the <a href="javascript:void(0)">card</a> component, you can
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>All Close Accordion</h3><span>Using the <a href="javascript:void(0)">card</a> component, you can
                            extend the default collapse behavior to create an accordion.</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Color Accordion</h3><span>Add <code>.bg-*</code> class to add background color with
                            card-header.</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Accordion With Icon on Title</h3><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along with icon
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Accordion open close icon</h3><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along with icon
                            class before title text.</span>
                    </div>
                    <div class="card-body">
