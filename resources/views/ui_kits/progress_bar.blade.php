    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Large Progress Bars</h3><span>Use <code> .lg-progress-bar</code>class to change progress size to
                            small:</span>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Basic Progress Bars</h3><span>Progress components are built with two HTML elements, some CSS to
                            set the width, and a few attributes.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
                            <div class="col">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Small Progress Bars</h3><span>Use <code> .sm-progress-bar</code>class to change progress size to
                            small:</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Custom Height Progress Bars</h3><span>Set a height value on the <code>.progress-bar</code>, so
                            if you change that value the outer <code>.progress </code> will automatically resize
                            accordingly.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="card">
                    <div class="card-header pb-0">
                        <h3>Multiple bars</h3><span>Include multiple progress bars in a progress component if you
                            need.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Progress Bars states</h3><span>Use state utility classes to change the appearance of individual
                            progress bars.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Progress Bars Striped</h3><span>Add <code>.progress-bar-striped</code> to any
                            <code>.progress-bar</code> to apply a stripe via CSS gradient over the progress bar’s background
                            color.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Progress Bars animated</h3><span>The striped gradient can also be animated. Add
                            <code>.progress-bar-animated</code> to <code>.progress-bar </code> to animate the stripes right
                            to left via CSS3 animations.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="progress">
                                    <div class="progress-bar-animated progress-bar-striped bg-info" role="progressbar"
                                        style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
