        ...
        <div class="user-profile social-app-profile">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card profile-header"><img class="img-fluid bg-img-cover"
                            src="{{ asset('assets/images/user-profile/bg-profile.jpg') }}" alt="">
                        ...
                        <div class="userpro-box">
                            <div class="img-wrraper">
                                ...
                                </div><a class="icon-wrapper" href="{{ route('edit-profile')}}"><i
                        ...
                        <div class="social-tab">
                            <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="top-timeline" data-bs-toggle="tab"
                                        href="#timeline" role="tab" aria-controls="timeline" aria-selected="true"><i
                                            data-feather="clock"></i>Timline</a></li>
                                <li class="nav-item"><a class="nav-link" id="top-about" data-bs-toggle="tab" href="#about"
                                        role="tab" aria-controls="about" aria-selected="false"><i
                                            data-feather="alert-circle"></i>About </a></li>
                                <li class="nav-item"><a class="nav-link" id="top-friends" data-bs-toggle="tab"
                                        href="#friends" role="tab" aria-controls="friends" aria-selected="false"><i
                                            data-feather="users"></i>Friends</a></li>
                                <li class="nav-item"><a class="nav-link" id="top-photos" data-bs-toggle="tab" href="#photos"
                                        role="tab" aria-controls="photos" aria-selected="false"><i
                                            data-feather="image"></i>Photos</a></li>
                            </ul>
            ...
            <div class="tab-content" id="top-tabContent">
                <div class="tab-pane fade show active" id="timeline" role="tabpanel" aria-labelledby="timeline">
                    <div class="row">
                        <div class="col-xl-3 col-md-5 box-col-40">
                                            ...
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseicon">My Profile</button>
                                                </h3>
                                            </div>
                                                ...
                                                <div class="card-body socialprofile filter-cards-view">
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-primary f-w-600">My Page</h5><span
                                                                class="d-block"><span><i class="fa fa-comments-o">
                                                                    </i><span class="px-2">Messages<span
                                                                            class="badge badge-pill badge-primary ms-1">9</span></span></span></span><span
                                                                class="d-block"><span><i class="fa fa-bell-o"> </i><span
                                                                        class="px-2">Notification<span
                                                                            class="badge badge-pill badge-primary ms-1">9</span></span></span></span>
                                                        </div>
                                                    </div>
                                                    <div class="social-btngroup d-flex">
                                                        <button class="btn btn-primary text-center me-2"
                                                            type="button">Likes</button>
                                                        <button class="btn btn-light text-center"
                                                            type="button">View</button>
                                                    </div>
                                                    <div class="likes-profile text-center">
                                                        <h4 class="f-w-600 mb-1"> <i class="fa fa-heart font-danger"></i>
                                                            884</h4>
                                                    </div>
                                            ...
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseicon1">Mutual Friends</button>
                                                </h3>
                                            </div>
                                            <div class="collapse show" id="collapseicon1" data-parent="#accordion"
                                                aria-labelledby="collapseicon1">
                                                <div class="card-body social-status filter-cards-view">
                                                    <form>
                                                        <div class="form-group m-0">
                                                            <input class="form-control-social" type="search"
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Bucky Barnes</span></a><span
                                                                class="d-block">winter@gmail.com</span></div>
                                                    </div>
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                                        <div class="social-status social-busy"></div>
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Sarah Loren</span></a><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Jason Borne</span></a><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="social-status social-offline"></div>
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Comeren Diaz</span></a><span
                                                                class="d-block">comere@gmail.com</span></div>
                                                    </div>
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/14.png') }}" alt="">
                                                        <div class="social-status social-online"></div>
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Andew Jon</span></a><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="social-status social-busy"></div>
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Johny Waston</span></a><span
                                                                class="d-block">johny@gmail.com</span></div>
                                                    </div>
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/3.png') }}" alt="">
                                                        <div class="social-status social-offline"></div>
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Johny William</span></a><span
                                                                class="d-block">johnyw@gmail.com</span></div>
                                                    </div>
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/2.png') }}" alt="">
                                                        <div class="social-status social-online"></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseicon12" aria-expanded="true"
                                                        aria-controls="collapseicon12">Activity Feed</button>
                                                </h3>
                                            </div>
                                            <div class="collapse show" id="collapseicon12"
                                                aria-labelledby="collapseicon12" data-parent="#accordion">
                                                <div class="card-body social-status filter-cards-view">
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Andew Jon</span></a>
                                                            <p>Commented on Shaun Park's <a
                                                                    href="javascript:void(0)">Photo</a></p><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Johny Waston</span></a>
                                                            <p>Commented on Shaun Park's <a
                                                                    href="javascript:void(0)">Photo</a></p><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Comeren Diaz</span></a>
                                                            <p>Commented on Shaun Park's <a
                                                                    href="javascript:void(0)">Photo</a></p><span
                                                    ...
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="f-w-600 d-block">Sarah Loren</span></a>
                                                            <p>Commented on Shaun Park's <a
                                                                    href="javascript:void(0)">Photo</a></p><span
                        ...
                        <div class="col-xl-6 col-md-7 box-col-60">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="new-users-social">
                                                <div class="d-flex"><img class="rounded-circle image-radius m-r-15"
                                                        src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                                                    <div class="flex-grow-1">
                                                        <h4 class="mb-0 f-w-700">ELANA</h4>
                                                        <p>January, 12,2019</p>
                                                    </div><span class="pull-right mt-0"><i data-feather="more-vertical">
                                                        </i></span>
                                                </div>
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="like-content mt-2"><span><i
                                                ...
                                                <div class="social-chat">
                                                    ...
                                                    <div class="text-center"><a class="f-w-600"
                                                            href="javascript:void(0)">More Comments</a></div>
                                                </div>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="input-group text-box">
                                                                ...
                                                                <div class="input-group-text"> <img
                                                                        src="{{ asset('assets/images/smiley.png') }}" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                                ...
                                                <div class="card-body filter-cards-view">
                                                    <div class="filter-view-group"><span class="f-w-600">About Me :</span>
                                                        <p>
                                                    ...
                                                    <div class="filter-view-group"><span class="f-w-600">Favourite TV
                                                            shows :</span>
                                                        <p>
                                                    ...
                                                    <div class="filter-view-group"><span class="f-w-600">Favourite Music
                                                            Bands :</span>
                                                        <p>
                                                            Breaking Good, RedDevil, People of
                                                            Interest, The Running Dead,
                                                    ...
                                                    <div class="social-network theme-form"><span class="f-w-600">Social
                                                            ...
                                                            href="https://www.dribbble.com" target="_blank"><i
                                            ...
                                            <div class="collapse show" id="collapseicon3" aria-labelledby="collapseicon3"
                                                ...
                                                <div class="card-body social-list filter-cards-view">
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="d-block">Bucky Barnes</span></a><a
                                                    ...
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="d-block">Sarah Loren</span></a><a
                                                                href="javascript:void(0)">Add Friend</a></div>
                                                    </div>
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle" alt=""
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="d-block">Jason Borne</span></a><a
                                                                href="javascript:void(0)">Add Friend</a></div>
                                                    </div>
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle" alt=""
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="d-block">Comeren Diaz</span></a><a
                                                                href="javascript:void(0)">Add Friend</a></div>
                                                    </div>
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle" alt=""
                                                        ...
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                                                                    class="d-block">Andew Jon</span></a><a
                                                                href="javascript:void(0)">Add Friend</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-6 box-col-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon10"
                                                aria-labelledby="collapseicon10" data-parent="#accordion">
                                                <div class="card-body social-list filter-cards-view">
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle" alt=""
                                                            src="{{ asset('assets/images/user/3.png') }}">
                                    ...
                                    <div class="col-xl-12 col-md-6 box-col-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon13" data-parent="#accordion"
                ...
                <div class="tab-pane fade" id="about" role="tabpanel" aria-labelledby="about">
                    <div class="row">
                        <div class="col-xl-3 col-lg-12 box-col-40">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseicon5" aria-expanded="true"
                                                        aria-controls="collapseicon5">My Profile</button>
                                                </h3>
                                            </div>
                                            <div class="collapse show" id="collapseicon5" aria-labelledby="collapseicon5"
                                                data-parent="#accordion">
                                                <div class="card-body socialprofile filter-cards-view">
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle"
                                                    ...
                                                    <div class="likes-profile text-center">
                                                        <h4 class="f-w-600"> <i class="fa fa-heart font-danger"></i> 884
                                                        </h4>
                                                    </div>
                                                    <h6 class="text-center">35 New Likes This Week</h6>
                                                    <div class="customers text-center social-group">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseicon6" aria-expanded="true"
                                                        aria-controls="collapseicon6">Mutual Friends</button>
                                                </h3>
                                            </div>
                                            <div class="collapse show" id="collapseicon6" data-parent="#accordion"
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseicon14" aria-expanded="true"
                                                        aria-controls="collapseicon14">Activity Feed</button>
                                                </h3>
                                            </div>
                                            <div class="collapse show" id="collapseicon14"
                                                aria-labelledby="collapseicon14" data-parent="#accordion">
                                                <div class="card-body social-status filter-cards-view">
                                                    <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                            src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                                        <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span
                        ...
                        <div class="col-xl-6 col-lg-12 box-col-60">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Jason Borne</span><a
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Anna Mull</span><a
                                                                href="{{ route('user-profile') }}">
                                                                <button class="btn btn-primary btn-xs">Add
                                                                    Friend</button></a></div>
                                                    </li>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Dion Cast</span><a
                                                                href="{{ route('user-profile') }}">
                                                                <button class="btn btn-primary btn-xs">Add
                                                                    Friend</button></a></div>
                                                    </li>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Karlene Lex</span><a
                                                                href="{{ route('user-profile') }}">
                                                                <button class="btn btn-primary btn-xs">Add
                                                                    Friend</button></a></div>
                                                    </li>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Vella Chism</span><a
                                                                href="{{ route('user-profile') }}">
                                                                <button class="btn btn-primary btn-xs">Add
                                                                    Friend</button></a></div>
                                                    </li>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                class="d-block f-w-600">Wai Schalk</span><a
                                                                href="{{ route('user-profile') }}">
                                                                <button class="btn btn-primary btn-xs">Add Friend
                                                                </button></a></div>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h3 class="f-w-600">Hobbies and Interests<span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span></h3>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">Hobbies:</h4>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">Favourite Music Bands / Artists:</h4>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">Favourite TV Shows:</h4>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">Favourite Books:</h4>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">Favourite Movies:</h4>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">Favourite Writers:</h4>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">Favourite Games:</h4>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">Other Interests:</h4>
                                                        <p>Swimming, Surfing, Sviho Diving, Anime, Photography, Tattoos,
                                                            Street Art.</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h3> <span class="f-w-600">Education and Employement</span><span
                                                    class="pull-right"><i data-feather="more-vertical"></i></span></h3>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">The New College of Design</h4>
                                                        <p>2001 - 2006</p>
                                                        <p>Breaking Good, RedDevil, People of Interest, The Running Dead,
                                                            Found, American Guy.</p>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">Digital Design Intern</h4>
                                                        <p>2006-2008</p>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">Rembrandt Institute</h4>
                                                        <p>2008</p>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs">
                                                        <h4 class="f-w-600">UI/UX Designer</h4>
                                                        <p>2001 - 2006</p>
                                                        <p>Breaking Good, RedDevil, People of Interest, The Running Dead,
                                                            Found, American Guy.</p>
                                                    </div>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details">
                                                        <h4 class="f-w-600">The Digital College</h4>
                                                        <p>2010</p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                href="{{ route('user-profile') }}">Add Friend</a></div>
                                                    </li>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="activity-log">
                                                ...
                                                <div class="my-activity">
                                                    <h4 class="f-w-600">25 December</h4>
                                                    <p><span><i class="m-r-20"
                                                                data-feather="thumbs-up"></i></span>Comeren Diaz likes
                                                        your photos.</p>
                                                    <p><span><i class="m-r-20" data-feather="thumbs-up"></i></span>Johny
                                                ...
                                                <div class="my-activity">
                                                    <h4 class="f-w-600">8 september</h4>
                                                    <p><span><i class="m-r-20"
                                                                data-feather="thumbs-up"></i></span>Comeren Diaz likes
                                                        your photos.</p>
                                                    <p><span><i class="m-r-20" data-feather="thumbs-up"></i></span>Johny
                        ...
                        <div class="col-xl-3 box-col-12">
                            <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc3">
                                <div class="row">
                                    <div class="col-xl-12 box-col-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon7"
                                                ...
                                                <div class="card-body filter-cards-view">
                                                    <div class="filter-view-group"><span class="f-w-600">About Me
                                                            :</span>
                                                        <p>
                                                            Hi, I’m elana, I’m 30 and I work as a
                                                            web Designer for the “Daydreams”
                                    ...
                                    <div class="col-xl-12 box-col-6 col-md-6 col-sm-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="p-0">
                                                    <button class="btn btn-link ps-0" data-bs-toggle="collapse"
                                                ...
                                                <div class="card-body social-list filter-cards-view">
                                                    ...
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><span class="d-block">Andew
                                                                Jon</span><a href="javascript:void(0)">Add Friend</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-12 box-col-6 col-md-6 col-sm-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon9" data-parent="#accordion"
                                    ...
                                    <div class="col-xl-12 box-col-6 col-md-6 col-sm-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon15" data-parent="#accordion"
                ...
                <div class="tab-pane fade" id="friends" role="tabpanel" aria-labelledby="friends">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 box-col-4">
                            <div class="card custom-card">
                                ...
                                <ul class="card-social">
                                    ...
                                    <li><a href="https://www.instagram.com" target="_blank"><i
                                                class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.rss.com" target="_blank"><i class="fa fa-rss"></i></a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="my-gallery card-body row gallery-with-description" itemscope="">
                                    <figure class="col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                    ...
                                    <figure class="col-xl-3 col-sm-6 box-col-33" itemprop="associatedMedia"
                                        itemscope=""><a href="{{ asset('assets/images/big-lightgallry/08.jpg') }}"
                                            itemprop="contentUrl" data-size="1600x950"><img
