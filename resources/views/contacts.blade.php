            ...
            <div class="row">
                <div class="col-xl-3 xl-30 box-col-30">
                    <div class="md-sidebar email-sidebar"><a class="btn btn-primary md-sidebar-toggle"
                            href="javascript:void(0)">contact filter </a>
                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar left-bookmark">
                                        ...
                                        <ul class="nav main-menu contact-options" role="tablist">
                                            <li class="nav-item">
                                                <button class="btn-primary badge-light btn-block btn-mail w-100"
                                                    type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                                        class="me-2" data-feather="users"></i> New Contacts</button>
                                            ...
                                            <li><a href="javascript:void(0)"><span class="title">Follow up</span></a>
                                            </li>
                                            <li><a href="javascript:void(0)"><span class="title">Favorites</span></a>
                                            </li>
                                            <li><a href="javascript:void(0)"><span class="title">Ideas</span></a></li>
                                            <li><a href="javascript:void(0)"><span class="title">Important</span></a>
                                            </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="pills-personal" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h3>Personal</h3><span class="f-14 pull-right mt-0">5 Contacts</span>
                                            </div>
                                                    ...
                                                    <div class="col-xl-8 xl-50 col-md-7 box-col-6">
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex align-items-center"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3><span class="first_name_0">Bucky
                                                                                </span><span
                                                                                    class="last_name_0">Barnes</span></h3>
                                                                            <p class="email_add_0">barnes@gmail.com</p>
                                                                            <ul>
                                                                    ...
                                                                    <div class="email-general">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>Gender <span
                                                                                    class="font-primary">Male</span></li>
                                                            ...
                                                            <div class="tab-pane contact-tab-1 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3><span class="first_name_1">Comeren
                                                                                </span><span
                                                                                    class="last_name_1">Diaz</span></h3>
                                                                            <p class="email_add_1">comeren@gmail.com</p>
                                                                            <ul>
                                                                                <li><a href="javascript:void(0)"
                                                                    ...
                                                                    <div class="email-general">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>Gender <span
                                                                                    class="font-primary">Female</span></li>
                                                                            <li>Birthday<span class="font-primary"> <span
                                                            ...
                                                            <div class="tab-pane contact-tab-2 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_2">Issa
                                                                                </span><span
                                                                                    class="last_name_2">Bell</span></h3>
                                                                            <p class="email_add_2">issabell@gmail.com</p>
                                                                            <ul>
                                                                                <li><a href="javascript:void(0)"
                                                            ...
                                                            <div class="tab-pane contact-tab-3 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_3">Andew
                                                            ...
                                                            <div class="tab-pane contact-tab-4 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_4">Jason
                                                                                </span><span
                                                                                    class="last_name_4">Borne</span></h3>
                                                                            <p class="email_add_4">jasonb@gmail.com</p>
                                                                            <ul>
                                                                                <li><a href="javascript:void(0)"
                                                            ...
                                                            <div class="tab-pane contact-tab-5 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_5">Monty
                                                                                </span><span
                                                                                    class="last_name_5">Carlo</span></h3>
                                                                            <p class="email_add_5">monty@gmail.com</p>
                                                                            <ul>
                                                                                <li><a href="javascript:void(0)"
                                                            ...
                                                            <div class="tab-pane contact-tab-6 tab-content-child fade"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                        ...
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_6">Brock
                                                        ...
                                                        <div class="contact-editform">
                                                            <form>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4 col-sm-6">
                                                                                <select class="js-example-basic-single">
                                                                                    <option value="pw">Personal web
                                                                                        address</option>
                                                                                    <option value="cw">Company web
                                                                                        address</option>
                                                                ...
                                                                </div><a class="ps-0 edit-information f-w-600"
                                                                    href="javascript:void(0)">Edit more information</a>
                                                ...
                                                <div class="row list-persons">
                                                    <div class="col-xl-4 xl-50 col-md-5 box-col-6">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab1"
                                                            role="tablist" aria-orientation="vertical"><a
                                                                ...
                                                                data-bs-toggle="pill" href="#v-pills-iduser"
                                                                role="tab" aria-controls="v-pills-iduser"
                                                                aria-selected="true">
                                                                <div class="d-flex"><img
                                                                ...
                                                                data-bs-toggle="pill" href="#v-pills-iduser1"
                                                                role="tab" aria-controls="v-pills-iduser1"
                                                                aria-selected="false">
                                                                <div class="d-flex"><img
                                                                        class="img-50 img-fluid m-r-20 rounded-circle"
                                                                ...
                                                                data-bs-toggle="pill" href="#v-pills-iduser2"
                                                                role="tab" aria-controls="v-pills-iduser2"
                                                                aria-selected="false">
                                                                <div class="d-flex"><img
                                                                        class="img-50 img-fluid m-r-20 rounded-circle"
                                                                ...
                                                                data-bs-toggle="pill" href="#v-pills-iduser3"
                                                                role="tab" aria-controls="v-pills-iduser3"
                                                                aria-selected="false">
                                                                <div class="d-flex"><img
                                                                        class="img-50 img-fluid m-r-20 rounded-circle"
                                                    ...
                                                    <div class="col-xl-8 xl-50 col-md-7 box-col-6">
                                                        <div class="tab-content" id="v-pills-tabContent1">
                                                            <div class="tab-pane fade show active" id="v-pills-iduser"
                                                                ...
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                            ...
                                                                            alt="">
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3><span class="first_name_5">Mark
                                                                                </span><span
                                                                                    class="last_name_5">jecno</span></h3>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-iduser1"
                                                                role="tabpanel" aria-labelledby="v-pills-iduser1-tab">
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                            class="img-100 img-fluid m-r-20 rounded-circle update_img_6"
                                                                            src="{{ asset('assets/images/user/3.jpg') }}"
                                                                            alt="">
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3><span class="first_name_6">Jason
                                                                                </span><span
                                                                                    class="last_name_6">Borne</span></h3>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-iduser2"
                                                                role="tabpanel" aria-labelledby="v-pills-iduser2-tab">
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                            ...
                                                                            alt="">
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3> <span class="first_name_7">Sarah
                                                                                </span><span
                                                                                    class="last_name_7">Loren</span></h3>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-iduser3"
                                                                role="tabpanel" aria-labelledby="v-pills-iduser3-tab">
                                                                <div class="profile-mail">
                                                                    <div class="d-flex"><img
                                                                            ...
                                                                            alt="">
                                                                        <div class="flex-grow-1 mt-0">
                                                                            <h3><span class="first_name_8">Andew
                                                                                </span><span class="last_name_8">Jon</span>
                                                                            </h3>
                                    ...
                                    <div id="right-history">
                                        <div class="modal-header p-l-20 p-r-20">
                                            <h4 class="modal-title w-100">Contact History<span class="pull-right"><a
                                                        class="closehistory" href="javascript:void(0)"><i
                                                            class="icofont icofont-close"></i></a></span></h4>
                                        </div>
                                                ...
                                                <div class="modal-body list-persons">
                                                    <div class="profile-mail pt-0" id="DivIdToPrint">
                                                        <div class="d-flex"><img
                                                                ...
                                                                alt="">
                                                            <div class="flex-grow-1 mt-0">
                                                                <h4><span id="printname">Bucky </span><span
                                                                        id="printlast">Barnes</span></h4>
