                        ...
                        <div>
                            <div>
                                <div class="row invo-header">
                                    <div class="col-sm-6">
                                        <div class="d-flex">
                                            <div class="d-flex-left"><a href="{{ route('dashboard') }}"><img class="d-flex-object img-60"
                                                        src="{{ asset('assets/images/logo/logo-icon.png') }}" alt=""></a></div>
                                            <div class="flex-grow-1 m-l-20">
                                                <h2 class="d-flex-heading f-w-600">Koho</h2>
                                                <p>hello@koho.in<br><span class="digits">289-335-6503</span></p>
                                            </div>
                                        </div>
                                        <!-- End Info -->
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="text-md-end text-xs-center">
                                            ...
                                            <p>Issued: May<span class="digits"> 27, 2022</span><br> Payment Due: June <span
                                                    class="digits">17, 2022</span></p>
                                        </div>
                                        <!-- End Title -->
                                    </div>
                                </div>
                                    ...
                                    <div class="invo-profile-left">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p>JohanDeo@gmail.com <span class="digits">945-684-7956</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
