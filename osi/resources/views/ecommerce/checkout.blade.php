                                        ...
                                        <div class="col">
                                            ...
                                            <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani1" type="radio"
                                                    name="rdo-ani" data-original-title="" title="">Cash On Delivery
                                            </label>
                                            <label class="d-block" for="edo-ani2">
                                                <input class="radio_animated" id="edo-ani2" type="radio"
                                                    name="rdo-ani" checked="" data-original-title=""
                                                    title="">PayPal<img class="img-paypal img-fluid"
                                                    src="{{ asset('assets/images/checkout/paypal.png') }}" alt="">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="order-place"><a class="btn btn-primary" href="{{ route('email-order-success')}}">Place
                                        Order </a></div>
                            </div>
                        </div>
                    </div>
