  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h3>KeyTable integration</h3><span>If you are looking to emulate the UI of spreadsheet programs such as Excel with DataTables, the combination of KeyTable and AutoFill will take you a long way there!</span>
          </div>
          <div class="card-body">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h3 class="mb-3">Header and Footer fixed</h3><span>When displaying tables with a particularly large amount of data shown on each page, it can be useful to have the table's header and footer fixed to the top or bottom of the scrolling window FixedHeader provides the ability to fix in place both. These are controlled by the options fixedHeader.header and fixedHeader.footer. Either can be optionally enabled, or as is the case in this example, both enabled.</span>
          </div>
          <div class="card-body">
            <div class="dt-ext table-responsive">
              ...
              <table class="display" id="export-button">
                ...
                <tbody>
                  <tr>
                    <td>Tiger Nixon</td>
                    <td>System Architect</td>
                    <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/dashboard/beyo-line/2.png') }}" alt=""></td>
                    <td>61</td>
                    <td>2011/04/25</td>
                    <td>$320,800</td>
                    <td>
                  ...
                  <tr>
                    <td>Ashton Cox</td>
                    <td>Junior Technical Author</td>
                    <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/dashboard/beyo-line/3.png') }}" alt=""></td>
                    <td>66</td>
                    <td>2009/01/12</td>
                    <td>$86,000</td>
                    <td>
                  ...
                  <tr>
                    <td>Airi Satou</td>
                    <td>Accountant</td>
                    <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/dashboard/beyo-line/4.png') }}" alt=""></td>
                    <td>33</td>
                    <td>2008/11/28</td>
                    <td>$162,700</td>
                    <td>
                  ...
                  <tr>
                    <td>Sonya Frost</td>
                    <td>Software Engineer</td>
                    <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/dashboard/beyo-line/1.png') }}" alt=""></td>
                    <td>23</td>
                    <td>2008/12/13</td>
                    <td>$103,600</td>
                    <td>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress-showcase">
                        <div class="progress sm-progress-bar">
                          <div class="progress-bar bg-secondary" role="progressbar" style="width: 60%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </td>
                    <td>2009/01/12</td>
