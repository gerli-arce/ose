...
@section('main-content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Whether Icons With Animations</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists whether-icon">
                                ...
                                <svg class="climacon climacon_tornado" id="tornado" version="1.1"
                                    ...
                                    <g class="climacon_iconWrap climacon_iconWrap-tornado">
                                        <g class="climacon_componentWrap climacon_componentWrap-tornado">
                                            ...
                                            <path
                                                class="climacon_component climacon_component-stroke climacon_component-stroke_tornadoLine"
                                                d="M47,64.456h3.999c1.104,0,2,0.896,2,1.999s-0.896,2-2,2H47c-1.104,0-2-0.896-2-2S45.896,64.456,47,64.456z">
                                            </path>
                                            <path
                                                class="climacon_component climacon_component-stroke climacon_component-stroke_tornadoLine"
                            ...
                            <!-- cloudSnowSun-->
                            <div class="col-lg-2 col-3">
                                <svg class="climacon climacon_cloudSnowSunFill" id="cloudSnowSunFill" version="1.1"
                                    viewBox="15 15 70 70">
                            ...
                            <!-- cloudSnowAlt-->
                            <div class="col-lg-2 col-3">
                                <svg class="climacon climacon_cloudSnowAltFill" id="cloudSnowAltFill" version="1.1"
                                    viewBox="15 15 70 70">
                                        ...
                                        <g class="climacon_wrapperComponent climacon_wrapperComponent-snowAlt">
                                            <g class="climacon_component climacon_component climacon_component-snowAlt">
                                                ...
                                                <circle
                                                    ...
                                                    fill="#FFFFFF" cx="50" cy="63.641" r="2">
                                                </circle>
                                            </g>
                                        </g>
                                        <g class="climacon_componentWrap climacon_componentWrap_cloud">
    ...
    <div class="icon-hover-bottom p-fixed icons-show-div">
      ...
      </div><div class="icon-hover-bottom p-fixed icons-show-div">
        <div class="container-fluid">
          <div class="row">
            <div class="icon-popup">
              <div class="close-icon"><i class="icofont icofont-close"></i></div>
