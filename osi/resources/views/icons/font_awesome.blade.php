    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row icon-lists">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pause-circle"></i>fa fa-pause-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pause-circle-o"></i>fa fa-pause-circle-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-percent"></i>fa fa-percent</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-product-hunt"></i>fa fa-product-hunt
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-reddit-alien"></i>fa fa-reddit-alien
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-scribd"></i>fa fa-scribd</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-shopping-bag"></i>fa fa-shopping-bag
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-shopping-basket"></i>fa
                                fa-shopping-basket</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stop-circle"></i>fa fa-stop-circle</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stop-circle-o"></i>fa fa-stop-circle-o
                            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Currency Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-turkish-lira"></i> fa-turkish-lira
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Web App Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-camera-retro"></i> fa-camera-retro
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-car"></i> fa-car</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-down"></i>
                                fa-caret-square-o-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-left"></i>
                                fa-caret-square-o-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-right"></i>
                                fa-caret-square-o-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-up"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-circle"></i> fa-check-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-circle-o"></i> fa-check-circle-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-square"></i> fa-check-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-square-o"></i> fa-check-square-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-circle-o-notch"></i> fa-circle-o-notch
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-cloud-download"></i> fa-cloud-download
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-cloud-upload"></i> fa-cloud-upload
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-dot-circle-o"></i> fa-dot-circle-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-envelope-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-exclamation-circle"></i>
                                fa-exclamation-circle</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-exclamation-triangle"></i>
                                fa-exclamation-triangle</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-external-link"></i> fa-external-link
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-external-link-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-archive-o"></i> fa-file-archive-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-audio-o"></i> fa-file-audio-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-code-o"></i> fa-file-code-o</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-excel-o"></i> fa-file-excel-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-image-o"></i> fa-file-image-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-movie-o"></i> fa-file-movie-o
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-photo-o"></i> fa-file-photo-o
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-picture-o"></i> fa-file-picture-o
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-powerpoint-o"></i>
                                fa-file-powerpoint-o</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-sound-o"></i> fa-file-sound-o
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-video-o"></i> fa-file-video-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-fire-extinguisher"></i>
                                fa-fire-extinguisher</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-flag"></i> fa-flag</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-flag-checkered"></i> fa-flag-checkered
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-folder-open-o"></i> fa-folder-open-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-graduation-cap"></i> fa-graduation-cap
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-location-arrow"></i> fa-location-arrow
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-forward"></i> fa-mail-forward
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-reply"></i> fa-mail-reply <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-reply-all"></i> fa-mail-reply-all
                                <span class="text-muted">(alias)</span></div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-microphone-slash"></i>
                                fa-microphone-slash</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-minus"></i> fa-minus</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-minus-circle"></i> fa-minus-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-minus-square"></i> fa-minus-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-minus-square-o"></i> fa-minus-square-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mobile"></i> fa-mobile</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mobile-phone"></i> fa-mobile-phone
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-money"></i> fa-money</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-moon-o"></i> fa-moon-o</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mortar-board"></i> fa-mortar-board
                                <span class="text-muted">(alias)</span></div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-paper-plane-o"></i> fa-paper-plane-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pencil-square"></i> fa-pencil-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pencil-square-o"></i>
                                fa-pencil-square-o</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-phone"></i> fa-phone</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-phone-square"></i> fa-phone-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-plus-square-o"></i> fa-plus-square-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-puzzle-piece"></i> fa-puzzle-piece
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-question-circle"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-search-minus"></i> fa-search-minus
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-share-alt-square"></i>
                                fa-share-alt-square</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-share-square"></i> fa-share-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-share-square-o"></i> fa-share-square-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-shield"></i> fa-shield</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-shopping-cart"></i> fa-shopping-cart
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-alpha-asc"></i> fa-sort-alpha-asc
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-alpha-desc"></i>
                                fa-sort-alpha-desc</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-amount-asc"></i>
                                fa-sort-amount-asc</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-amount-desc"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-down"></i> fa-sort-down <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-numeric-asc"></i>
                                fa-sort-numeric-asc</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-numeric-desc"></i>
                                fa-sort-numeric-desc</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-up"></i> fa-sort-up <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-space-shuttle"></i> fa-space-shuttle
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-star-half-empty"></i>
                                fa-star-half-empty <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-star-half-full"></i> fa-star-half-full
                                <span class="text-muted">(alias)</span></div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-thumbs-o-down"></i> fa-thumbs-o-down
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-times-circle"></i> fa-times-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-times-circle-o"></i> fa-times-circle-o
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-left"></i> fa-toggle-left <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-right"></i> fa-toggle-right
                                <span class="text-muted">(alias)</span></div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-video-camera"></i> fa-video-camera
                            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Spinner Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-circle-o-notch"></i>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Form Control Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-square"></i> fa-check-square
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Text Editor Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-align-center"></i> fa-align-center
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-align-justify"></i> fa-align-justify
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chain"></i> fa-chain <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chain-broken"></i> fa-chain-broken
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rotate-left"></i> fa-rotate-left <span
                                    class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rotate-right"></i> fa-rotate-right
                                <span class="text-muted">(alias)</span></div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-strikethrough"></i> fa-strikethrough
                            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Directional Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-angle-double-down"></i>
                                fa-angle-double-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-angle-double-left"></i>
                                fa-angle-double-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-angle-double-right"></i>
                                fa-angle-double-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-angle-double-up"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-down"></i>
                                fa-arrow-circle-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-left"></i>
                                fa-arrow-circle-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-down"></i>
                                fa-arrow-circle-o-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-left"></i>
                                fa-arrow-circle-o-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-right"></i>
                                fa-arrow-circle-o-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-up"></i>
                                fa-arrow-circle-o-up</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-right"></i>
                                fa-arrow-circle-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-up"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-down"></i>
                                fa-caret-square-o-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-down"></i>
                                fa-chevron-circle-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-left"></i>
                                fa-chevron-circle-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-right"></i>
                                fa-chevron-circle-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-up"></i>
                                fa-chevron-circle-up</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-down"></i> fa-chevron-down
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-left"></i> fa-chevron-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-right"></i> fa-chevron-right
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-hand-o-right"></i> fa-hand-o-right
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-hand-o-up"></i> fa-hand-o-up</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-long-arrow-down"></i>
                                fa-long-arrow-down</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-long-arrow-left"></i>
                                fa-long-arrow-left</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-long-arrow-right"></i>
                                fa-long-arrow-right</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-long-arrow-up"></i> fa-long-arrow-up
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-down"></i> fa-toggle-down
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-left"></i> fa-toggle-left
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-right"></i> fa-toggle-right
                                <span class="text-muted">(alias)</span></div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-up"></i> fa-toggle-up <span
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Video Player Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-fast-backward"></i> fa-fast-backward
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-fast-forward"></i> fa-fast-forward
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-play-circle"></i> fa-play-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-play-circle-o"></i> fa-play-circle-o
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-step-backward"></i> fa-step-backward
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-step-forward"></i> fa-step-forward
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stop"></i> fa-stop</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-youtube-play"></i> fa-youtube-play
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row icon-lists">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-behance-square"></i>
                                fa-behance-square</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-bitbucket"></i> fa-bitbucket</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-bitbucket-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-facebook-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-github-square"></i> fa-github-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-google-plus"></i> fa-google-plus
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-google-plus-square"></i>
                                fa-google-plus-square</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-hacker-news"></i> fa-hacker-news
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-linkedin-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pied-piper-alt"></i>
                                fa-pied-piper-alt</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pinterest"></i> fa-pinterest</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-pinterest-square"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-reddit-square"></i> fa-reddit-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stack-exchange"></i>
                                fa-stack-exchange</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stack-overflow"></i>
                                fa-stack-overflow</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-steam"></i> fa-steam</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-steam-square"></i> fa-steam-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stumbleupon"></i> fa-stumbleupon
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stumbleupon-circle"></i>
                                fa-stumbleupon-circle</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-tencent-weibo"></i> fa-tencent-weibo
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-tumblr-square"></i> fa-tumblr-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-twitter"></i> fa-twitter</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-twitter-square"></i>
                                fa-twitter-square</div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-vimeo-square"></i> fa-vimeo-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-xing-square"></i> fa-xing-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-youtube-square"></i>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="m-b-0">Medical Icons</h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-plus-square"></i> fa-plus-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-stethoscope"></i> fa-stethoscope
                            </div>
