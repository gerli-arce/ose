        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Grid Options</h3><span>Bootstrap grid allows building an equal height flexbile blocks
                            easily</span>
                    </div>
                    <div class="card-body">
                        <p>While Bootstrap uses <code>em </code>or <code>rem </code>for defining most sizes, <code>px</code>
                            are used for grid breakpoints and container widths. This is because the viewport width is in
                            pixels and does not change with the <a href="javascript:void(0)">font size</a>.</p>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Extra extra large<br><small class="digits">≥1400px</small>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body grid-showcase">
                        <p>Using a single set of <code>.col-md-*</code> grid classes, you can create a basic grid system
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body grid-showcase">
                        <p>Use <code>.order-</code> classes for controlling the <strong>visual order</strong> of your
                            content. These classes are responsive, so you can set the <code>order</code> by breakpoint
                            (e.g., <code>.order-1.order-md-2</code>). Includes support for <code>1</code> through
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body grid-showcase">
                        <p>Move columns to the right using <code>.offset-md-*</code> classes. These classes increase the
                            left margin of a column by <code>*</code> columns. For example, <code>.offset-md-4</code> moves
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0"><span>.col-sm-5 .offset-sm-2 .col-md-6
                                    .offset-md-0</span></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-5 col-lg-6"><span>.col-sm-6 .col-md-5 .col-lg-6</span></div>
                            <div class="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0"><span>.col-sm-6 .col-md-5
                                    .offset-md-2 .col-lg-6 .offset-lg-0</span></div>
                        </div>
                    </div>
                </div>
            </div>
