    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle bg-transparent border-none"
                                    data-bs-toggle="dropdown" href="javascript:void(0)" role="button" aria-haspopup="true"
                                    aria-expanded="false">Dropdown</a>
                                <div class="dropdown-menu"><a class="dropdown-item" id="profile-tab" data-bs-toggle="tab"
                                        href="#profile" role="tab" aria-controls="profile"
                                        aria-selected="false">Action</a><a class="dropdown-item"
                                        href="javascript:void(0)">Another action</a><a class="dropdown-item"
                                        href="javascript:void(0)">Something else here</a><a class="dropdown-item"
                                        href="javascript:void(0)">Separated link</a></div>
                            </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="bottom-tabContent">
                            <div class="tab-pane fade show active" id="bottom-home" role="tabpanel"
                                ...
                                <p class="m-b-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                            ...
                            <div class="tab-pane fade" id="bottom-contact" role="tabpanel"
                                ...
                                <p class="m-b-30">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                                    when an unknown printer took a galley of type and scrambled it to make a type specimen
                                    book. It has survived not only five centuries, but also the leap into electronic
                                    typesetting, remaining essentially unchanged. It was popularised in the 1960s with the
                        ...
                        <ul class="nav nav-tabs nav-bottom" id="bottom-tab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="bottom-home-tab" data-bs-toggle="tab"
                                    href="#bottom-home" role="tab" aria-controls="bottom-home"
                                    aria-selected="true"><i class="icofont icofont-ui-home"></i>Home</a></li>
                            <li class="nav-item"><a class="nav-link" id="profile-bottom-tab" data-bs-toggle="tab"
                                    href="#bottom-profile" role="tab" aria-controls="profile-icon"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="contact-bottom-tab" data-bs-toggle="tab"
                                    href="#bottom-contact" role="tab" aria-controls="contact-icon"
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-right" id="right-tab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="profile-right-tab" data-bs-toggle="tab"
                                    href="#right-profile" role="tab" aria-controls="profile-icon"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="contact-right-tab" data-bs-toggle="tab"
                                    href="#right-contact" role="tab" aria-controls="contact-icon"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                    aria-orientation="vertical"><a class="nav-link active" id="v-pills-home-tab"
                                        ...
                                        aria-controls="v-pills-home" aria-selected="true">Home</a><a class="nav-link"
                                        id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile"
                                        role="tab" aria-controls="v-pills-profile"
                                        aria-selected="false">Profile</a><a class="nav-link" id="v-pills-messages-tab"
                                        data-bs-toggle="pill" href="#v-pills-messages" role="tab"
                                        aria-controls="v-pills-messages" aria-selected="false">Messages</a><a
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills" id="pills-icontab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="pills-iconprofile-tab" data-bs-toggle="pill"
                                    href="#pills-iconprofile" role="tab" aria-controls="pills-iconprofile"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-iconcontact-tab" data-bs-toggle="pill"
                                    href="#pills-iconcontact" role="tab" aria-controls="pills-iconcontact"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
                        <div class="tab-content" id="pills-icontabContent">
                            <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel"
                                ...
                                <p class="mb-0 m-t-30">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    ...
                                    typesetting, remaining essentially unchanged. It was popularised in the 1960s with the
                                    release of Letraset sheets containing Lorem Ipsum passages, and more recently with
                                    desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.It
                                    was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
                                    passages, and more recently with desktop publishing software like Aldus PageMaker
                                    including versions of Lorem IpsumIt was popularised in the 1960s with the release of
                                    Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publish
                                    It was popularised in the 1960s with the release of Letraset sheets containing Lorem
                                    Ipsum passages, and more</p>
                            </div>
                            <div class="tab-pane fade" id="pills-iconprofile" role="tabpanel"
                                ...
                                <p class="mb-0 m-t-30">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    ...
                                    passages, and more recently with desktop publishing software like Aldus PageMaker
                                    including versions of Lorem IpsumIt was popularised in the 1960s with the release of
                                    Letraset sheets containing Lorem Ipsum passages, and more recently</p>
                            </div>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card height-equal">
                    <div class="card-header pb-0">
                        <h3>Pill Dark color</h3><span>Add <code>.nav-*</code> class with nav class</span><span>remove
                            <code>nav-pill</code> class from pill style Tab</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-dark" id="pills-darktab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="pills-darkhome-tab"
                                    ...
                                    aria-controls="pills-darkhome" aria-selected="true"><i
                                        class="icofont icofont-ui-home"></i>Home</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-darkprofile-tab" data-bs-toggle="pill"
                                    href="#pills-darkprofile" role="tab" aria-controls="pills-darkprofile"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-darkcontact-tab" data-bs-toggle="pill"
                                    href="#pills-darkcontact" role="tab" aria-controls="pills-darkcontact"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
                        <div class="tab-content" id="pills-darktabContent">
                            <div class="tab-pane fade show active" id="pills-darkhome" role="tabpanel"
                                ...
                                <p class="mb-0 m-t-30">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    ...
                                    typesetting, remaining essentially unchanged. It was popularised in the 1960s with the
                                    release of Letraset sheets containing Lorem Ipsum passages, and more recently with
                                    desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum in
                                    the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,It has
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Primary Color</h3><span>Add <code>.nav-primary</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Secondary Color</h3><span>Add <code>.nav-secondary</code> class with nav class</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-pills nav-secondary" id="pills-successtab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="pills-successhome-tab"
                                    ...
                                    aria-controls="pills-successhome" aria-selected="true"><i
                                        class="icofont icofont-ui-home"></i>Home</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-successprofile-tab" data-bs-toggle="pill"
                                    href="#pills-successprofile" role="tab" aria-controls="pills-successprofile"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-successcontact-tab" data-bs-toggle="pill"
                                    href="#pills-successcontact" role="tab" aria-controls="pills-successcontact"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Success Color</h3><span>Add <code>.nav-success</code> class with nav class</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-pills nav-success" id="pills-clrtab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="pills-clrprofile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-clrcontact-tab" data-bs-toggle="pill"
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Info Color</h3><span>Add <code>.nav-info</code> class with nav class</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-pills nav-info" id="pills-infotab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="pills-infoprofile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-infocontact-tab" data-bs-toggle="pill"
                                    href="#pills-infocontact" role="tab" aria-controls="pills-infocontact"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Warning Color</h3><span>Add <code>.nav-warning</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Danger Color</h3><span>Add <code>.nav-danger</code> class with nav class</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-pills nav-danger" id="pills-danger-tab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="pills-danger-home-tab"
                                    ...
                                    aria-controls="pills-danger-home" aria-selected="true"><i
                                        class="icofont icofont-ui-home"></i>Home</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-danger-profile-tab" data-bs-toggle="pill"
                                    href="#pills-danger-profile" role="tab" aria-controls="pills-danger-profile"
                                    aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="pills-danger-contact-tab" data-bs-toggle="pill"
                                    href="#pills-danger-contact" role="tab" aria-controls="pills-danger-contact"
                                    aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a></li>
                        </ul>
