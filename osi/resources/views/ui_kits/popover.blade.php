    ...
    <div class="container-fluid">
        <div class="row popover-main">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Basic Examples</h3><span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
                    </div>
                    <div class="card-body btn-showcase">
                        <button class="btn btn-primary example-popover" type="button" data-bs-toggle="popover"
                            ...
                            popover</button><a class="example-popover btn btn-primary" tabindex="0" role="button"
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Direction</h3><span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
                    </div>
                    <div class="card-body btn-showcase">
