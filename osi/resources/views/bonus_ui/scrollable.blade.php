    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="scroll-bar-wrap">
                            <div class="click-drag-handler scroll-demo p-0"><img src="{{ asset('assets/images/banner/2.jpg') }}"
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Small Size Scroll</h3>
                    </div>
                    <div class="card-body">
                        <div class="scroll-bar-wrap">
                            <div class="scrollbar-margins large-margin scroll-demo p-0"><img
                                    src="{{ asset('assets/images/banner/3.jpg') }}" alt="girl" width="800" height="600"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Both Side Scroll</h3>
                    </div>
                    <div class="card-body">
                        <div class="scroll-bar-wrap">
                            <div class="both-side-scroll scroll-demo p-0"><img src="{{ asset('assets/images/banner/1.jpg') }}"
                                    alt="girl" width="800" height="600"></div>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                                                ...
                                                College in Virginia, looked up one of the more obscure Latin words.It was
                                                popularised in the 1960s with the release of Letraset sheets containing
                                                Lorem Ipsum passages, and more recently with desktop publishing software
                                                like Aldus PageMaker including versions of Lorem Ipsum.</p>
                                        </div>
                                        <div class="col-sm-3">
                                            <p>It is a long established fact that a reader will be distracted by the
                                                ...
                                                English. Many desktop publishing packages and web page editors.It was
                                                popularised in the 1960s with the release of Letraset sheets containing
                                                Lorem Ipsum passages, and more recently with desktop publishing software
                                                like Aldus PageMaker including versions of Lorem Ipsum.</p>
                                        </div>
