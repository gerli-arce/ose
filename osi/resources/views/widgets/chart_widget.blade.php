                ...
                <div class="card o-hidden">
                    <div class="chart-widget-top">
                        <div class="row card-body">
                            <div class="col-5">
                                <h4 class="f-w-600 font-primary">SALE</h4><span class="num"><span
            ...
            <div class="col-xl-4 col-md-12 box-col-12">
                <div class="card o-hidden">
                    <div class="chart-widget-top">
                        <div class="row card-body">
                            <div class="col-7">
                                <h4 class="f-w-600 font-secondary">PROJECTS</h4><span class="num"><span
            ...
            <div class="col-xl-4 col-md-12 box-col-12">
                <div class="card o-hidden">
                    <div class="chart-widget-top">
                        <div class="row card-body">
                            <div class="col-8">
                                <h4 class="f-w-600 font-success">PRODUCTS</h4><span class="num"><span
                ...
                <div class="card o-hidden">
                    ...
                    <div class="card-body p-0">
                        <div class="code-box-copy">
                            <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#marketing-expenses"
                                title="" data-bs-original-title="Copy" aria-label="Copy"><i
                                    class="icofont icofont-copy-alt"></i></button>
                            <pre><code class="language-html" id="marketing-expenses">&lt;div class="card o-hidden"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;h3&gt;Marketing Expenses&lt;/h3&gt;
&lt;div class="card-header-right"&gt;
&lt;ul class="list-unstyled card-option"&gt;
                        ...
                        <div class="bottom-content card-body">
                            ...
                            <div class="row text-center">
                                <div class="col-4 b-r-light">
                                    <div><span class="font-primary">12%<i class="icon-angle-up f-12 ms-1"></i></span><span
                                            class="text-muted block-bottom">Year</span>
                                        <h2 class="num m-0"><span class="counter color-bottom">3659</span>M</h2>
                                    </div>
                                </div>
                                <div class="col-4 b-r-light">
                                    <div><span class="font-primary">15%<i class="icon-angle-up f-12 ms-1"></i></span><span
                                            class="text-muted block-bottom">Month</span>
                                        <h2 class="num m-0"><span class="counter color-bottom">698</span>M</h2>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div><span class="font-primary">34%<i class="icon-angle-up f-12 ms-1"></i></span><span
                                            class="text-muted block-bottom">Today</span>
                                        <h2 class="num m-0"><span class="counter color-bottom">9361</span>M</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="small-chart-widget chart-widgets-small">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="code-box-copy">
                                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#live-product"
                                    title="" data-bs-original-title="Copy" aria-label="Copy"><i
                                        class="icofont icofont-copy-alt"></i></button>
                                <pre><code class="language-html" id="live-product">&lt;div class="small-chart-widget chart-widgets-small"&gt;
&lt;div class="card"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;h3&gt;Live Products&lt;/h3&gt;
&lt;div class="card-header-right"&gt;
&lt;ul class="list-unstyled card-option"&gt;
 &lt;li&gt;
   &lt;div&gt;&lt;i class="icon-settings"&gt;&lt;/i&gt;&lt;/div&gt;&lt;/li&gt;
   &lt;li&gt;&lt;i class="view-html fa fa-code"&gt;&lt;/i&gt;&lt;/li&gt;
   &lt;li&gt;&lt;i class="icofont icofont-maximize full-card"&gt;&lt;/i&gt;&lt;/li&gt;
   &lt;li&gt;&lt;i class="icofont icofont-minus minimize-card"&gt;&lt;/i&gt;&lt;/li&gt;
   &lt;li&gt;&lt;i class="icofont icofont-refresh reload-card"&gt;&lt;/i&gt;&lt;/li&gt;
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
        ...
        <div class="row">
            ...
            <div class="col-xl-7 col-lg-12 box-col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-9">
