  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <div class="site">
          <div class="site-bd">
            <div class="wrapper">
              <div class="card">
                <div class="card-header pb-0 language-header">
                  <h3>Internationalization</h3>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="masthead" role="banner">
                        <ul class="icon-lists border navs-icon hList hList_loose masthead-nav js-languageList">
                          <li><a href="javascript:void(0)"><span> Base</span></a></li>
                          <li><a href="javascript:void(0)"><span> Advance</span></a>
                            <ul class="hList hList_loose masthead-nav js-languageList">
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Scrollable</span></a></li>
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Tree View</span></a></li>
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Rating</span></a></li>
                            </ul>
                          </li>
                          <li><a href="javascript:void(0)"><span data-mlr-text=""> Forms</span></a></li>
                          <li><a href="javascript:void(0)"><span data-mlr-text=""> Tables</span></a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-sm-6 language-xs">
                      ...
                      <div class="masthead" role="banner">
                        <ul class="icon-lists border navs-icon hList hList_loose masthead-nav js-languageList">
                          ...
                          <li><a href="javascript:void(0)"><span> Advance</span></a>
                            <ul class="hList hList_loose masthead-nav js-languageList">
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Scrollable</span></a><span class="pull-right badge badge-primary">New</span></li>
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Tree View</span></a><span class="pull-right badge badge-primary">Find</span></li>
                              <li class="pl-navs-inline"><a href="javascript:void(0)"><span>Rating</span></a></li>
                            </ul>
                          </li>
                          <li><a href="javascript:void(0)"><span data-mlr-text=""> Forms</span></a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header pb-0">
            <h3>How To Use It</h3><span>Add a class<code>.hdg, .hdg_main, .js-languagePageHdg, .hList, .hList_loose, .masthead-nav., js-languageList, .langChoice, .js-languageSelect</code>class to any tag for language translate</span>
          </div>
          <div class="card-body">
            <div class="language">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header pb-0">
            <h3>How To Add Language</h3><span>you can also add other language according to below in js and add lanuage type in langChoice</span>
          </div>
          <div class="card-body">
