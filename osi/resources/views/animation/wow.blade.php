            ...
            <div class="col-sm-12">
                        ...
                        <div class="row gallery grid my-gallery" id="aniimated-thumbnials" itemscope="">
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/4.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/4.jpg') }}"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow pulse" itemprop="associatedMedia"
                                data-wow-iteration="5" data-wow-duration="0.15s" itemscope=""><a
                                    ...
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/5.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/6.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/6.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInLeft" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/7.jpg') }}" itemprop="contentUrl"
                                    data-size="11600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/7.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow flipInX center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/8.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/8.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/9.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/9.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/10.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/10.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow shake" itemprop="associatedMedia"
                                data-wow-iteration="5" data-wow-duration="0.15s" itemscope=""><a
                                    ...
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/11.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow swing center" itemprop="associatedMedia"
                                data-wow-iteration="2" itemscope=""><a href="{{ asset('assets/images/big-masonry/12.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/14.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/14.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow lightSpeedIn" itemprop="associatedMedia"
                                data-wow-delay="0.5s" data-wow-duration="0.15s" itemscope=""><a
                                    ...
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/13.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/15.jpg') }}" itemprop="contentUrl"
                                    data-size="1600x950"><img class="img-thumbnail" src="{{ asset('assets/images/masonry/15.jpg') }}"
                                        itemprop="thumbnail" alt="Image description"></a>
                            ...
                            <div class="pswp__scroll-wrap">
                                ...
                                <div class="pswp__ui pswp__ui--hidden">
                                    <div class="pswp__top-bar">
                                        ...
                                        <!-- element will get class  when preloader is running-->
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-primary rounded-pill me-2">1</span>Setup wow.js</h3><span>(You can
                            link to another CSS animation library by changing wow.js settings)</span>
                    </div>
                    <div class="card-body">
                        <div>
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-primary rounded-pill me-2">2</span>Link and activate wow.js</h3>
                    </div>
                    <div class="card-body">
                        <div>
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-primary rounded-pill me-2">3</span>Make an element revealable</h3>
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-primary rounded-pill me-2">4</span>Choose the animation style</h3>
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-success rounded-pill me-2">Extra</span>Advance Options</h3>
                    </div>
                    <div class="card-body">
                        <div>
                            <div class="line">
                ...
                <div class="card">
                    <div class="card-header wow-title pb-0">
                        <h3><span class="badge badge-danger rounded-pill me-2">Settings</span>Customize Settings</h3>
                    </div>
                    <div class="card-body">
                        <div>
                            <div class="line">
                                ...
                                <p><strong>live: </strong>c onsatantly check for new WOW elements on the page.</p>
