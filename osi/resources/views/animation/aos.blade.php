    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="row gallery grid my-gallery" id="aniimated-thumbnials">
                            <figure class="grid-item col-sm-3" data-aos="fade-down"><a
                                    href="{{ asset('assets/images/big-masonry/1.jpg') }}" data-size="1600x950"><img
                            ...
                            <figure class="grid-item col-sm-3" data-aos="zoom-out-down"><a
                                    href="{{ asset('assets/images/big-masonry/2.jpg') }}" data-size="1600x950"><img
                            ...
                            <figure class="grid-item col-sm-3" data-aos="flip-down"><a
                                    href="{{ asset('assets/images/big-masonry/3.jpg') }}" data-size="1600x950"><img
                            ...
                            <figure class="grid-item col-sm-3" data-aos="flip-left"><a
                                    href="{{ asset('assets/images/big-masonry/15.jpg') }}" data-size="1600x950"><img
                                        class="img-thumbnail" src="{{ asset('assets/images/masonry/15.jpg') }}"
                                        alt="Image description"></a>
                                <figcaption>Image caption 14</figcaption>
                            </figure>
                            <figure class="grid-item col-sm-3" data-aos="flip-down"><a
                                    href="{{ asset('assets/images/big-masonry/13.jpg') }}" data-size="1600x950"><img
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div><span class="comment">// The Below Function is example of how to initlize reveal</span>
                            <div class="line"><span></span> &lt;script&gt; <span></span><br><code>
                                    AOS.init();</code><br><span> &lt;</span> /script <span> &gt; </span></div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>How to use it?</h3><span>All you have to do is to add <code>data-aos</code> attribute to html
                            element, like so:</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h3> Advanced settings</h3><span>These settings can be set both on certain elements, or as default
                            while initializing script (in options object without <code> data- part).</code></span>
                    </div>
