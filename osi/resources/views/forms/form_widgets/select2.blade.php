        ...
        <div class="select2-drpdwn">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h3 class="card-title">Select-2</h3>
                        </div>
                        <div class="card-body o-hidden">
                            ...
                            <div>
                                ...
                                <div class="text-end mt-2">
                                    <button class="btn btn-primary js-programmatic-enable mt-2">Enable</button>
                                    <button class="btn btn-danger js-programmatic-disable mt-2">Disable</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h3 class="card-title">Outline Color Variant</h3>
                        </div>
                        <div class="card-body">
                            <div class="mb-2">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h3 class="card-title">Full Colored Variant</h3>
                        </div>
                        <div class="card-body">
                            <div class="mb-2">
                                <div class="col-form-label">Primary Select</div>
