...
@section('main-content')
    ...
    <div class="container-fluid">
        <div class="email-wrap bookmark-wrap">
            <div class="row">
                <div class="col-xl-3 xl-25 box-col-25">
                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar left-bookmark">
                                        ...
                                        <ul class="nav main-menu" role="tablist">
                                            <li class="nav-item">
                                                <button class="btn-primary btn-block btn-mail" type="button"
                                            ...
                                            <li><a class="show" id="pills-newsletter-tab" data-bs-toggle="pill"
                                                    href="#pills-newsletter" role="tab" aria-controls="pills-newsletter"
                                                    aria-selected="false"><span class="title"> Newsletter</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-9 col-md-12 xl-75">
                                    ...
                                    <div class="tab-pane fade active show" id="pills-created" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h3 class="f-w-600 mb-0">Created by me</h3>
                                                <ul>
                                            ...
                                            <div class="card-body pb-0">
                                                <div class="details-bookmark text-center">
                                                    <div class="row" id="bookmarkData">
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                                ...
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_0">Admin Template</h4>
                                                                            <p class="weburl_0">
                                                                                http://admin.pixelstrap.com/endless/ltr/landing-page.html
                                                                            </p>
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_0">Endless is beautifully
                                                                                    crafted, clean and modern designed admin
                                                                                    theme with 6 different demos and light -
                                                                                    dark versions.</p><span
                                                        ...
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_1">Koho Template</h4>
                                                                            <p class="weburl_1">
                                                                                https://admin.pixelstrap.com/koho/template/landing-page
                                                                            </p>
                                                                            <div class="hover-block">
                                                                                <ul>
                                                                                    <li><a href=""
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_1">Universal is beautifully
                                                                                    crafted, clean and modern designed admin
                                                                                    theme</p><span
                                                        ...
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_2">Angular Theme</h4>
                                                                            <p class="weburl_2">
                                                                                https://angular.pixelstrap.com/endless/landing
                                                                            </p>
                                                                            <div class="hover-block">
                                                                                <ul>
                                                                                    <li><a href=""
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_2">Endless is beautifully
                                                                                    crafted, clean and modern designed admin
                                                                                    theme</p><span
                                                        ...
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_3">Multikart Admin</h4>
                                                                            <p class="weburl_3">
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_3">Multikart Admin is modern
                                                                                    designed admin theme</p><span
                                                        ...
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_4">Ecommerece theme</h4>
                                                                            <p class="weburl_4">
                                                                                http://themes.pixelstrap.com/multikart</p>
                                                                            <div class="hover-block">
                                                                                <ul>
                                                                                    <li><a href=""
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_4">Multikart HTML template
                                                                                    is an apparently simple but highly
                                                                                    functional tempalate designed for
                                                                                    creating a flourisahing online business.
                                                        ...
                                                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 box-col-25">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_5">Tovo app landing page</h4>
                                                                            <p class="weburl_5">
                                                                                http://vue.pixelstrap.com/tovo/home-one</p>
                                                                            <div class="hover-block">
                                                                                <ul>
                                                                                    <li><a href=""
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_5">Amazing Landing Page With
                                                                                    Easy Customization</p><span
                                                        ...
                                                        <div class="col-xl-3 col-md-4 xl-50">
                                                            <div class="card bookmark-card o-hidden">
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            <h4 class="title_1">Universal Template</h4>
                                                                            <p class="weburl_1">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input class="form-control" id="editurl" type="text"
                                                                    ...
                                                                    value="http://admin.pixelstrap.com/endless/ltr/landing-page.html">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label>Title</label>
