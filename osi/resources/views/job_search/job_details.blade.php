                                        ...
                                        <div class="collapse show" id="collapseicon4" data-parent="#accordion"
                                            ...
                                            <div class="card-body animate-chk">
                                                ...
                                                <label class="d-block" for="chk-ani24">
                                                    <input class="checkbox_animated" id="chk-ani24" type="checkbox">
                                                    Node.js
                                                </label>
                                                <label class="d-block" for="chk-ani25">
                                                    <input class="checkbox_animated" id="chk-ani25" type="checkbox"> Gulp
                                                    & Pug
                                                </label>
                        ...
                        <div class="card-body">
                            <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                ...
                                <div class="flex-grow-1">
                                    <h3 class="f-w-600"><a href="javascript:void(0)">Product Designer (UI/UX Designer)
                                        </a></h3>
                                    ...
                                    <ul class="rating">
                                        ...
                                        <li><i class="fa fa-star font-warning"></i></li>
                                        <li><i class="fa fa-star font-warning"> </i></li>
                                    </ul><a class="btn btn-primary btn-sm job-apply-btn" href="{{ route('job-apply')}}">Apply for
                                        this job</a>
                                </div>
                            </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-700"><a href="javascript:void(0)">React/React Native
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-700"><a href="javascript:void(0)">Front end web
                                    ...
                                    <p>Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface components and Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-700"><a href="javascript:void(0)">Graphic designer</a><span
                                    ...
                                    <p>Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React. Bonus points if you have React Native experience. Professional experience of React Native and other front end frameworks.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-700"><a href="javascript:void(0)">Designer, CRM</a><span
                                                    class="pull-right">3 days ago</span></h3>
                                    ...
                                    <p>Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial. Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="f-w-700"><a href="javascript:void(0)">Senior UX designer</a><span
