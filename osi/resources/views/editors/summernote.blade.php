    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Air-mode Summernote</h3>
                    </div>
                    <div class="card-body pt-0">
                        <div class="inline-editor">
                            <h2 class="mb-3 mt-3">You can select content and edit inline</h2>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Hint for words Summernote</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3>Click To Edit Summernote</h3>
                    </div>
                    <div class="card-body">
