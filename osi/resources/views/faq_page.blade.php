      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="row default-according style-1 faq-accordion" id="accordionoc">
            <div class="col-xl-8 xl-60 col-lg-6 col-md-7 box-col-60">
              <div class="card">
                ...
                <div class="collapse" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordionoc">
                  <div class="card-body">
                    <p>How you approach this process will depend on which web host you use. For example, a lot of hosting providers use cPanel, which includes an option to set up subdomains with just a few clicks.</p>
                  </div>
                </div>
              </div>
              <div class="card">
              ...
              <div class="card">
                ...
                <div class="collapse" id="collapseicon3" data-parent="#accordionoc">
                  <div class="card-body">
                    <p>Manually adding meta tags in WordPress is relatively simple. For this demo, we’ll use the example from the WordPress Codex. Imagine you’re Harriet Smith, a veterinarian who blogs about their animal stories on WordPress.</p>
                  </div>
                </div>
              </div>
              <div class="card">
              ...
              <div class="card">
                ...
                <div class="collapse" id="collapseicon11" data-parent="#accordionoc">
                  <div class="card-body">
                    <p>Validating a website is the process of ensuring that the pages on the website conform to the norms or standards defined by various organizations.
                    </p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div class="collapse" id="collapseicon12" data-parent="#accordionoc">
                  <div class="card-body">
                    <p>A book or set of books giving information on many subjects or on many aspects of one subject. Some are intended as an entry point into research for a general audience, some provide detailed information.</p>
                  </div>
                </div>
              </div>
              <div class="faq-title">
            ...
            <div class="col-xl-4 xl-40 col-lg-6 col-md-5 box-col-40">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card card-mb-faq xs-mt-search">
                    <div class="card-header faq-header">
                      <h3 class="ps-0">Search Articles</h3><i data-feather="help-circle"></i>
                    </div>
                ...
                <div class="col-lg-12">
                  <div class="card card-mb-faq">
                    <div class="card-header faq-header">
                      <h3 class="ps-0">Navigation</h3><i data-feather="settings"></i>
                    </div>
                    <div class="card-body faq-body">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header faq-header">
                      <h3 class="d-inline-block ps-0">Latest Updates</h3><span class="pull-right d-inline-block">See All</span>
                    </div>
                    <div class="card-body faq-body">
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-body"><a href="{{ route('learning-detailed')}}">
                    <h6>Web Design</h6></a>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>Mar 02, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star-o font-primary"></i></li>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>Feb 04, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>Jan 18, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
